...
COPY ["ProductOrder.Domain/ProductOrder.Domain.csproj", "ProductOrder.Domain/"]
...
RUN dotnet build "./ProductOrder.Api.csproj" -c $BUILD_CONFIGURATION -o /app/build

# This stage is used to publish the service project to be copied to the final stage
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./ProductOrder.Api.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
